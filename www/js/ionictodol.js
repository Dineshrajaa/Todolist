...
.controller('todolctrl', function($scope,$ionicModal,$timeout,$ionicSideMenuDelegate,$ionicActionSheet,Projects){
  ...
  $scope.updateStatus=function(task,index){ 
  ...
  $scope.showActionSheet=function(task,$index){
